...
<div class="address_box">
    ...
    <div class="addr_form_box">
        <div class="addr_input_box"><input id="name" name="name" type="text" placeholder="姓名" class="addr_input" required="required"/></div>
        <div class="addr_input_box"><input id="phone" name="phone" type="text" placeholder="联系电话" class="addr_input" required="required" /></div>
        <div class="addr_input_box"><input id="zip" name="zip" type="text" placeholder="邮编 (选填)" class="addr_input" /></div>
        <div class="addr_input_box"><textarea id="address" name="address" rows="2" cols="20" placeholder="详细地址" class="addr_textarea" required="required"></textarea></div>
    </div>
